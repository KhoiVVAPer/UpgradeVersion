...
echo "GRAPHQL_API_URL="$GRAPHQL_API_URL_STAGE >> .env
echo "COGNITO_USERNAME="$COGNITO_USERNAME_STAGE >> .env
echo "COGNITO_PASSWORD="$COGNITO_PASSWORD_STAGE >> .env
echo "AWS_REGION="$AWS_REGION >> .env
echo "AWS_USER_POOL_ID="$AWS_USER_POOL_ID_STAGE >> .env
echo "AWS_USER_POOL_WEB_CLIENT_ID="$AWS_USER_POOL_WEB_CLIENT_ID_STAGE >> .env
echo "ADOBE_ENV_ID="$ADOBE_ENV_ID_STAGE >> .env
