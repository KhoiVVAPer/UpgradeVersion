...
import Table from '../../../../../components/custom/layoutManager/table';
import { table } from '../../../../../assets/data/pageContent';
...
describe('components > custom > layoutManager > Table', () => {
  let component;
  const props = {
    layoutData: JSON.parse(table.config)
  };
  beforeEach(() => {
