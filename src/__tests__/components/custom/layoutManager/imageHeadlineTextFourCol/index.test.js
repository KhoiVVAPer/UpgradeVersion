...
import ImageHeadlineTextFourCol from '../../../../../components/custom/layoutManager/imageHeadlineTextFourCol';
import { imageHeadlineTextFourCol } from '../../../../../assets/data/pageContent';

const setUp = (props) => {
  const component = shallow(<ImageHeadlineTextFourCol {...props} />);
  return component;
};

describe('components > custom > layoutManager > ImageHeadlineTextFourCol', () => {
  let component;
  const props = {
    layoutData: JSON.parse(imageHeadlineTextFourCol.config)
  };
  beforeEach(() => {
