...
import FullWidthImage from '../../../../../components/custom/layoutManager/fullWidthImage';
import { fullWidthImage } from '../../../../../assets/data/pageContent';

const setUp = (props) => {
  const component = shallow(<FullWidthImage {...props} />);
  return component;
};

describe('components > custom > layoutManager > FullWidthImage', () => {
  let component;
  const props = {
    layoutData: JSON.parse(fullWidthImage.config)
  };
  beforeEach(() => {
